...
public class User{
    public static void main(String[] args){
        ...
        System.out.println("Enter 1 to Sign in, enter 2 to sign up:");
        Scanner in = new Scanner(System.in);
        int choice = in.nextInt();
        while(choice != 1 && choice != 2){
            System.out.println("The option you entered isn't supported. Please enter either 1 (to sign in) or 2 (to sign up):");
            choice = in.nextInt();
        }
        Client c1;
        if(choice == 1){
        ...
        try{
            ...
            InputStream masterHost = sock.getInputStream();
            BufferedReader mHostIn = new BufferedReader(new InputStreamReader(masterHost));

            String line;
            while((line = mHostIn.readLine()) != null){
